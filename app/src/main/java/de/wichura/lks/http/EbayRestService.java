...
public class EbayRestService {
    ...
    private interface WebService {
        ...
        // &OPERATION-NAME=findItemsByKeywords&SERVICE-VERSION=1.0.0&RESPONSE-DATA-FORMAT=JSON&callback=_cb_findItemsByKeywords&REST-PAYLOAD
        // &keywords=tabou 3s&paginationInput.entriesPerPage=6&GLOBAL-ID=EBAY-DE&siteid=77
    ...
    public Observable<JsonObject> findItemsByKeywordObersv(String keywords) {
        return mEbayRestService.findItemsByKeyword("berndwic-luftkraf-PRD-c7a9b454f-48afe28f",
                "findItemsByKeywords", "1.0.0", "JSON", "_cb_findItemsByKeywords", "", keywords);
    }
}